...
/**
 * Created by cenxiaozhong on 2017/6/17. source code https://github.com/Justson/AgentWeb
 */
...
public class CustomWebViewFragment extends AgentWebFragment {
  ...
  public static final CustomWebViewFragment getInstance(Bundle bundle) {
    ...
    if (bundle != null) mCustomWebViewFragment.setArguments(bundle);
  ...
  public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
    ...
    mAgentWeb = AgentWeb.with(this)//
        ...
        .setWebViewClient(mWebViewClient).setReceivedTitleCallback(mCallback)
        .setWebView(mMarkdownWebView).setSecurityType(AgentWeb.SecurityType.strict).createAgentWeb()//
        .ready()//
        .go(null);
