...
/**
 * Created by cenxiaozhong on 2017/5/26. source code https://github.com/Justson/AgentWeb
 */
...
public class JsAgentWebFragment extends AgentWebFragment {
  ...
  public static final JsAgentWebFragment getInstance(Bundle bundle) {
    ...
    if (bundle != null) mJsAgentWebFragment.setArguments(bundle);
  ...
  public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
    ...
    if (mAgentWeb != null) {
      mAgentWeb.getJsInterfaceHolder().addJavaObject("android",
          new AndroidInterface(mAgentWeb, this.getActivity()));
  ...
  private View.OnClickListener mOnClickListener = new View.OnClickListener() {
    ...
    public void onClick(View v) {
      ...
      switch (v.getId()) {
        ...
        case R.id.three:
          mAgentWeb.getJsEntraceAccess().quickCallJs("callByAndroidMoreParams",
